...
(1, 300, '100.00', 1, 1631992780),
(2, 300, '150.00', 0, 1631995950);
...
CREATE TABLE `t_users` (
  ...
  `step` int(2) DEFAULT 0 COMMENT 'Помощник (шаги обучалки, в проекте их 5)',
  PRIMARY KEY (`uid`),
  key (log,ref)
