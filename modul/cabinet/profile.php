...
<div id="aj_p_person" class="h_fon_field">'.Prof\PersonalData::getProfilePersonalInfo().'</div></div>';


//Платёжные данные
Opt::$main_content.='<div class="text_fon">
<h4 class="h_fon_min">'.Def100\LangLibCabMain::ARR_INDEX[Opt::$lang]['payment'].'</h4>
<div class="h_fon_field"><h4 class="h_fon_min">'.Def100\LangLibCabMain::ARR_PROFILE[Opt::$lang]['ps'].' '.Def100\OptCab::paysSystems(1).'</h4>
<div id="aj_p_wal" class="h_fon_field">'.Prof\PaymentData::getProfilePerfectInfo().'</div></div></div>';