...
<div class="text_fon"><div id="aj_p">
<h4 class="h_fon_min">'.Def100\LangLibCabMain::ARR_SUPPORT[Opt::$lang]['support_form'].'</h4>
...
Opt::$main_content .= '<script type="text/javascript">var fs_btn=true;
...
});function formSupport(arr){if(arr.l==1){$.jGrowl(arr.answer,{theme:"growl-error",life:4000});fs_btn=true;}else if(arr.l==2){document.getElementById("aj_p").innerHTML="<p>"+arr.answer+"</p>";}}</script>';